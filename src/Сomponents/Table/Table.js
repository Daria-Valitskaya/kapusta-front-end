...
import { useEffect, useMemo, useTable } from 'react';
...
//     }
// };
const TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYxYmI5MjgzMDRiOGJiNDg2ZDBiMGUyYiIsImlhdCI6MTYzOTc2ODk5NX0.85_P-ZMaWneekfqe-5TRp5xcdfXKHWbgxA4TkDvziSo'
            ...
            <tbody className={s.tbody}>
                ...
                {dataIncome.map(item => (
                    <tr key={item._id} className={s.tr}>
                        <td>{item.date}</td>
                        <td><EllipsisText text={item.description} length={30} /></td>
                        <td>{item.category}</td>
