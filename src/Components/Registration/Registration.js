        ...
        <>
            <div className={s.registrationWindow}>
                <div className="with-google">
                    <p className={s.description}>Вы можете зарегистрироваться с помощью Google Account:</p>
                    <button className={s.googleButton} type="button">
                        <FcGoogle size="20px" />
                        Google
                    </button>
                    <p className={s.description}>Или зарегистрироваться с помощью e-mail и пароля:</p>
                </div>
                <Formik
                    ...
                    {({
                        ...
                        <form className={s.form} onSubmit={handleSubmit}>
                            ...
                            <div className={s.emailField}>
                                <InputLabel className={s.label} htmlFor="email">Электронная почта:</InputLabel>
                                <TextField
                                    fullWidth
                                    className={s.input}
                                    variant="filled"
                            ...
                            <InputLabel className={s.label} htmlFor="password">Пароль:</InputLabel>
                            ...
                            <InputLabel className={s.label} htmlFor="password">Подтвердите пароль:</InputLabel>
                            <div className={s.passwordField}>
                                <TextField
                                    fullWidth
                                    className={s.input}
                                ...
                                <div className={s.passwordIconButton}>
                                    {values.confirmPassword &&
                                        <IconButton aria-label="visibility" onClick={toggleConfirmPassword} >
                                            {showPassword ? <VisibilityOff /> : <Visibility />}
                                        </IconButton>
                                    }
                                </div>
